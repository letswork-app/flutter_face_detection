 ...
 */
package plugins.letswork.letsface.ui;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        synchronized (lock) {
            ...
            if(showText != null) {
                ...
                textPaint.setTextSize((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 24, getResources().getDisplayMetrics()));
                textPaint.setTextAlign(Paint.Align.CENTER);
                textPaint.setShadowLayer(20, 0, 0, Color.BLACK);
                canvas.drawText(showText, getWidth() / 2.0f, getHeight() / 2.0f, textPaint);
            }
        }
